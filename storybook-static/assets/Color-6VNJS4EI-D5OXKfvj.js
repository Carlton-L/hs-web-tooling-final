import {
  ...
  I as $e,
  g as Ne,
} from "./index-d0oDUDnS.js";
import { R as h, r as b } from "./index-DH5ua8nC.js";
import { g as fe } from "./_commonjsHelpers-Cpj98o6Y.js";
import { _ as Oe, i as J, a as Ie } from "./index-UvUotFBn.js";
import "./iframe--fp1qZ6t.js";
import "../sb-preview/runtime.js";
import "./index-D9uilScg.js";
import "./index-Bw8VTzHM.js";
...
var S = function (e, t, n) {
  ...
  ne = function (e, t, n) {
    var r = e.getBoundingClientRect(),
      o = j(t)
        ...
        : t;
    return {
      left: S((o.pageX - (r.left + V(e).pageXOffset)) / r.width),
      top: S((o.pageY - (r.top + V(e).pageYOffset)) / r.height),
    };
  },
  re = function (e) {
    ...
    var t = e.onMove,
      ...
      c = b.useMemo(
        function () {
          var k = function (p) {
              re(p),
                (j(p) ? p.touches.length > 0 : p.buttons > 0) && o.current
                  ? a(ne(o.current, p, l.current))
                  : _(!1);
            },
            N = function () {
              return _(!1);
          ...
          function _(p) {
            var m = i.current,
              x = V(o.current),
              C = p ? x.addEventListener : x.removeEventListener;
            C(m ? "touchmove" : "mousemove", k),
              C(m ? "touchend" : "mouseup", N);
          }
          return [
            function (p) {
              var m = p.nativeEvent,
              ...
              if (
                ...
                x.focus(), a(ne(x, m, l.current)), _(!0);
              }
            },
            function (p) {
  ...
  ee = function (e) {
    var t = e.color,
      ...
      r = e.top,
      o = r === void 0 ? 0.5 : r,
      a = z(["react-colorful__pointer", e.className]);
  ...
  de = function (e) {
    ...
    var a = Math.floor(t),
      ...
      c = a % 6;
    return {
      r: y(255 * [r, l, s, s, i, r][c]),
      g: y(255 * [i, r, r, l, s, s][c]),
      b: y(255 * [s, s, i, r, r, l][c]),
      a: y(o, 2),
    };
  },
  He = function (e) {
  ...
  me = h.memo(function (e) {
    var t = e.hue,
      n = e.onChange,
      r = z(["react-colorful__hue", e.className]);
    return h.createElement(
      "div",
      { className: r },
      h.createElement(
    ...
    return h.createElement(
      ...
      h.createElement(
        Z,
        {
          ...
          onKey: function (o) {
            n({
              s: S(t.s + 100 * o.left, 0, 100),
              v: S(t.v - 100 * o.top, 0, 100),
            });
          },
          "aria-label": "Color",
          "aria-valuetext":
...
function ye(e, t, n) {
  var r = K(n),
    ...
    a = o[0],
    s = o[1],
    l = b.useRef({ color: t, hsva: a });
  b.useEffect(
    function () {
      if (!e.equal(t, l.current.color)) {
        var c = e.toHsva(t);
        (l.current = { hsva: c, color: t }), s(c);
      }
    },
    [t, e],
  ),
    b.useEffect(
      function () {
        ...
        ve(a, l.current.hsva) ||
          ...
          ((l.current = { hsva: a, color: c }), r(c));
      },
      [a, e, r],
    );
  var i = b.useCallback(function (c) {
    s(function (d) {
...
var qe = typeof window < "u" ? b.useLayoutEffect : b.useEffect,
  Be = function () {
  ...
  We = function (e) {
    var t = e.className,
      ...
      a = e.onChange,
      s = Q(e, ["className", "colorModel", "color", "onChange"]),
      l = b.useRef(null);
    xe(l);
    var i = ye(n, o, a),
      c = i[0],
      d = i[1],
      f = z(["react-colorful", t]);
    return h.createElement(
      "div",
      $({}, s, { ref: l, className: f }),
  ...
  De = function (e) {
    return h.createElement(We, $({}, e, { colorModel: Xe }));
  },
  Ke = function (e) {
    var t = e.className,
      n = e.hsva,
  ...
  Ae = function (e) {
    return h.createElement(we, $({}, e, { colorModel: Ve }));
  },
  Ge = {
  ...
  Ue = function (e) {
    return h.createElement(we, $({}, e, { colorModel: Ge }));
  },
  Ye = {
...
u.rgb.hsl = function (e) {
  ...
  const c = (o + a) / 2;
  return (
    a === o ? (i = 0) : c <= 0.5 ? (i = s / (a + o)) : (i = s / (2 - a - o)),
    [l, i * 100, c * 100]
  );
};
...
u.hcg.rgb = function (e) {
  ...
  return (
    (i = (1 - n) * r),
    [(n * o[0] + i) * 255, (n * o[1] + i) * 255, (n * o[2] + i) * 255]
  );
};
  ...
  for (t[e].distance = 0; n.length; ) {
    ...
    for (let a = o.length, s = 0; s < a; s++) {
      const l = o[s],
        i = t[l];
      i.distance === -1 &&
        ((i.distance = t[r].distance + 1), (i.parent = r), n.unshift(l));
    }
  }
  return t;
}
...
function tt(e, t) {
  ...
  let r = B[t[e].parent][e],
    o = t[e].parent;
  for (; t[o].parent; )
    n.unshift(t[o].parent), (r = et(B[t[o].parent][o], r)), (o = t[o].parent);
...
ot.forEach((e) => {
  (O[e] = {}),
    Object.defineProperty(O[e], "channels", { value: U[e].channels }),
    Object.defineProperty(O[e], "labels", { value: U[e].labels });
  const t = rt(e);
  Object.keys(t).forEach((r) => {
    const o = t[r];
    (O[e][r] = st(o)), (O[e][r].raw = at(o));
  });
});
var lt = O;
const w = fe(lt);
...
function Et(e) {
  ...
  e = pt(e);
  var n = wt.test(e);
  return n || kt.test(e) ? _t(e.slice(2), n ? 2 : 8) : xt.test(e) ? se : +e;
}
var Mt = Et,
  Ct = J,
  D = ut,
...
function It(e, t, n) {
  ...
  (t = le(t) || 0),
    Ct(n) &&
      ((d = !!n.leading),
      (f = "maxWait" in n),
      (a = f ? Nt(le(n.maxWait) || 0, t) : a),
      (g = "trailing" in n ? !!n.trailing : g));
  function k(v) {
    var E = r,
      T = o;
    return (r = o = void 0), (c = v), (s = e.apply(T, E)), s;
  }
  function N(v) {
    return (c = v), (l = setTimeout(m, t)), d ? k(v) : s;
  }
  function _(v) {
    var E = v - i,
      T = v - c,
      te = t - E;
    return f ? Ot(te, a - T) : te;
  }
  function p(v) {
    var E = v - i,
      T = v - c;
    return i === void 0 || E >= t || E < 0 || (f && T >= a);
  }
  function m() {
    var v = D();
    if (p(v)) return x(v);
  ...
  function x(v) {
    return (l = void 0), g && r ? k(v) : ((r = o = void 0), s);
  }
  function C() {
    l !== void 0 && clearTimeout(l), (c = 0), (r = i = o = l = void 0);
  }
  function X() {
    return l === void 0 ? s : x(D());
  }
  function R() {
    var v = D(),
      E = p(v);
    if (((r = arguments), (o = this), (i = v), E)) {
      if (l === void 0) return N(i);
      if (f) return clearTimeout(l), (l = setTimeout(m, t)), k(i);
    }
    return l === void 0 && (l = setTimeout(m, t)), s;
  }
  return (R.cancel = C), (R.flush = X), R;
}
var St = It,
  Rt = St,
  Tt = J,
...
function Ft(e, t, n) {
  var r = !0,
    o = !0;
  if (typeof e != "function") throw new TypeError(jt);
  return (
    Tt(n) &&
...
var zt = Ft;
const Ht = fe(zt);
var Pt = M.div({ position: "relative", maxWidth: 250 }),
  Lt = M(ue)({ position: "absolute", zIndex: 1, top: 4, left: 4 }),
  qt = M.div({
    width: 200,
    margin: 5,
  ...
  Bt = M(Me)(({ theme: e }) => ({ fontFamily: e.typography.fonts.base })),
  Wt = M.div({
    display: "grid",
  ...
  ie = ({ value: e, active: t, onClick: n, style: r, ...o }) => {
    let a = `linear-gradient(${e}, ${e}), ${Dt}, linear-gradient(#fff, #fff)`;
    return h.createElement(Xt, {
      ...o,
      active: t,
      onClick: n,
      style: { ...r, backgroundImage: a },
    });
  },
  Kt = M(Ce.Input)(({ theme: e }) => ({
    width: "100%",
    paddingLeft: 30,
    paddingRight: 30,
  ...
  I = (e) => {
    ...
    if (Gt.test(e)) {
      let [s, l, i, c] = ce(e),
        [d, f, g] = w.rgb.hsl([s, l, i]) || [0, 0, 0];
      return {
        valid: t,
        value: e,
        keyword: w.rgb.keyword([s, l, i]),
        colorSpace: "rgb",
        rgb: e,
        hsl: `hsla(${d}, ${f}%, ${g}%, ${c})`,
        hex: `#${w.rgb.hex([s, l, i]).toLowerCase()}`,
      };
    }
    if (Ut.test(e)) {
      let [s, l, i, c] = ce(e),
        [d, f, g] = w.hsl.rgb([s, l, i]) || [0, 0, 0];
      return {
        valid: t,
        value: e,
        keyword: w.hsl.keyword([s, l, i]),
        colorSpace: "hsl",
        rgb: `rgba(${d}, ${f}, ${g}, ${c})`,
        hsl: e,
        hex: `#${w.hsl.hex([s, l, i]).toLowerCase()}`,
      };
    }
    let n = e.replace("#", ""),
      r = w.keyword.rgb(n) || w.hex.rgb(n),
      o = w.rgb.hsl(r),
      a = e;
    if (
  ...
  Qt = (e, t, n) => {
    if (!e || !(t != null && t.valid)) return L[n];
    if (n !== "hex") return (t == null ? void 0 : t[n]) || L[n];
    if (!t.hex.startsWith("#"))
      try {
        return `#${w.keyword.hex(t.hex)}`;
      } catch {
        return L.hex;
      }
    let r = t.hex.match(Yt);
    if (!r) return Y.test(t.hex) ? t.hex : L.hex;
    let [o, a, s] = r[1].split("");
    return `#${o}${o}${a}${a}${s}${s}`;
  },
  Zt = (e, t) => {
    let [n, r] = b.useState(e || ""),
      [o, a] = b.useState(() => I(n)),
      [s, l] = b.useState((o == null ? void 0 : o.colorSpace) || "hex");
    b.useEffect(() => {
      let f = e || "",
        g = I(f);
      r(f), a(g), l((g == null ? void 0 : g.colorSpace) || "hex");
    }, [e]);
    let i = b.useMemo(() => Qt(n, o, s).toLowerCase(), [n, o, s]),
      c = b.useCallback(
        (f) => {
          let g = I(f),
            k = (g == null ? void 0 : g.value) || f || "";
          r(k),
            k === "" && (a(void 0), t(void 0)),
      ...
      d = b.useCallback(() => {
        let f = P.indexOf(s) + 1;
        f >= P.length && (f = 0), l(P[f]);
        let g = (o == null ? void 0 : o[P[f]]) || "";
        r(g), t(g);
      }, [o, s, t]);
    return {
      value: n,
    ...
    let a = b.useMemo(
      ...
      s = b.useCallback(
        (l) => {
          l != null &&
            l.valid &&
            (a.some((i) => W(i[n]) === W(l[n])) || o((i) => i.concat(l)));
        },
        [n, a],
      );
  ...
  tn = ({
    ...
    let l = b.useCallback(Ht(n, 200), [n]),
      {
        value: i,
        realValue: c,
        updateValue: d,
      ...
      { presets: N, addPreset: _ } = en(a, f, g),
      p = Jt[g];
    return h.createElement(
      Pt,
      null,
      h.createElement(
                ...
                N.map((m, x) =>
                  h.createElement(
                    ue,
                    {
                      key: `${m.value}-${x}`,
                      hasChrome: !1,
                      tooltip: h.createElement(Bt, {
                        note: m.keyword || m.value,
                      }),
                    },
                    h.createElement(ie, {
                      value: m[g],
                      active: f && W(m[g]) === W(f[g]),
                      onClick: () => d(m.value),
                    }),
                  ),
                ),
        ...
        h.createElement(ie, { value: c, style: { margin: 4 } }),
      ),
      h.createElement(Kt, {
        id: Ne(e),
        value: i,
      ...
      i ? h.createElement(Vt, { icon: "markup", onClick: k }) : null,
    );
  },
  hn = tn;
export { tn as ColorControl, hn as default };
