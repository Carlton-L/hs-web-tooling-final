import { j as e } from "./jsx-runtime-DQ32znRX.js";
import { M as a } from "./index-d0oDUDnS.js";
import { useMDXComponents as o } from "./index-mlbUBBkt.js";
...
const n =
  ...
  j = "" + new URL("accessibility-W_h2acOZ.png", import.meta.url).href,
  u = "" + new URL("theming-D6WJLNoW.png", import.meta.url).href,
  f = "" + new URL("addon-library-BWUCAmyN.png", import.meta.url).href,
  s = () => {
    const t = Object.assign({ svg: "svg", path: "path" }, o());
    return e.jsx(t.svg, {
      viewBox: "0 0 14 14",
      width: "8px",
      height: "14px",
...
function F(t = {}) {
  const { wrapper: i } = Object.assign({}, o(), t.components);
  return i ? e.jsx(i, Object.assign({}, t, { children: e.jsx(r, t) })) : r(t);
}
export { s as RightArrow, F as default };
